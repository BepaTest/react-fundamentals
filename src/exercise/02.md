...
- Imperative Programming: 'go streight, turn right, bla bla bla'
- Declarative Programming: 'adresse: 9, rue Bonheur, Lyon'

- React.createElement('div', propreties)
- ReactDOM.render(element, rootElement) = rootElement.append(element)
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=vera.testard%40gmail.com).
